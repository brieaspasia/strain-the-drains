...
svg(filename="images/heatmap.svg")
draw(heatmap, width=unit(12, "in"), height=unit(7, "in"))
dev.off()
...
svg("images/p_timeseries.svg")
plot(p_timeseries, height=7, width=12, units="in")
dev.off()
...
svg("images/p_glmmtotal.svg")
plot(p_glmmtotal, height=7, width=12, units="in")
dev.off()
```
...
svg("images/p_all.svg")
plot(p_all, height=7, width=12, units="in")
dev.off()
...
svg("images/p_mds.svg", height=7, width=11)
plot(p_mds, height=7, width=11, units="in")
dev.off()
...
svg("images/p_mds_txt.svg", height=7, width=11)
plot(p_mds_txt, height=7, width=11, units="in")
dev.off()
