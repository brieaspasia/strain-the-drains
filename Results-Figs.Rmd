...
# ***NOTES create one graph here, no facets, but dodge luz with items on y and total on x***
# 
# pred_luz_items$LUZ <- with(pred_luz_items, reorder(LUZ, item, FUN = mean))
# 
# pred_luz_items <- with(pred_luz_items, pred_luz_items[order(item, -as.numeric(LUZ)), ])
